...
function scrambledStringInit(tag, objName, initString) {
    init_string = initString;
    init_scrambled_string = initString;
    init_scrambled_string_indices = [];
    this.scrambledString = scrambledString;
    for (i = 0; i < init_string.length; i++) {
        init_scrambled_string_indices[i] = i;
    }
    this.scrambledString(tag, objName, init_scrambled_string, init_scrambled_string_indices);
}
